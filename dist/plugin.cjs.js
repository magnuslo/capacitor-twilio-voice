...
const CapacitorTwilioVoice = core.registerPlugin('CapacitorTwilioVoice', {
  web: () =>
    Promise.resolve()
      ...
      .then((m) => new m.CapacitorTwilioVoiceWeb()),
});
...
class CapacitorTwilioVoiceWeb extends core.WebPlugin {
  ...
  async endCall(options) {
    ...
    if (!gracefulDone) {
      try {
        ...
        const callSidForHangup =
          ((_a = call.parameters) === null || _a === void 0 ? void 0 : _a.CallSid) || c.outboundConnectionId;
  ...
  async getCallStatus() {
    ...
    return {
      ...
      isOnHold: false,
      isMuted:
        (_b = (_a = this.activeCall) === null || _a === void 0 ? void 0 : _a.isMuted()) !== null && _b !== void 0
          ? _b
          : false,
      callSid,
      callState,
  ...
  async resolveDefaultOutputDeviceId() {
    var _a, _b;
    try {
      if (!((_a = navigator.mediaDevices) === null || _a === void 0 ? void 0 : _a.enumerateDevices)) return null;
      const devices = await navigator.mediaDevices.enumerateDevices();
      ...
      return (_b = explicit === null || explicit === void 0 ? void 0 : explicit.deviceId) !== null && _b !== void 0
        ? _b
        : outputs[0].deviceId;
    } catch (_c) {
      return null;
  ...
  wireDeviceEvents(device) {
    ...
    device.on('incoming', (call) => {
      var _a, _b, _c, _d;
      const callSid =
        ((_a = call.parameters) === null || _a === void 0 ? void 0 : _a.CallSid) || `incoming-${Date.now()}`;
      this.wireCallEvents(call, callSid);
      ...
      if (
        ((_d = call.parameters) === null || _d === void 0 ? void 0 : _d.Params) &&
